...
.. image:: https://github.com/evildecay/etcdkeeper/blob/master/logo/logo-horizontal.png
   :target: https://github.com/evildecay/etcdkeeper/blob/master/logo/logo-horizontal.png
   :alt: image
...
* Based easyui framework to achieve(easyui license `easyui website <http://www.jeasyui.com>`_\ ).
...
* `Download other platform releases <https://github.com/evildecay/etcdkeeper/releases>`_.
  .. code-block::
...
* Get data based on etcd user permissions.
  ...
  * `enable etcdv3 authentication <https://github.com/etcd-io/etcd/blob/master/Documentation/op-guide/authentication.md>`_
  * `enable etcdv2 authentication <https://github.com/etcd-io/etcd/blob/master/Documentation/v2/authentication.md>`_
...
* Content edits use the ace editor(\ `Ace editor <https://ace.c9.io>`_\ ). Support toml,ini,yaml,json,xml and so on to highlight view.
* Content format. (Currently only support json, Other types can be extended later) Thanks jim3ma for his contribution.\ `@jim3ma <https://github.com/jim3ma>`_
...
Because the etcdv3 version uses the new storage concept, without the catalog concept, the client uses the previous default "/" delimiter to view. See the documentation for etcdv3 `clientv3 doc <https://godoc.org/github.com/coreos/etcd/clientv3>`_.
...
.. image:: https://github.com/evildecay/etcdkeeper/blob/master/screenshots/ui.png
   :target: https://github.com/evildecay/etcdkeeper/blob/master/screenshots/ui.png
   :alt: image
...
.. image:: https://github.com/evildecay/etcdkeeper/blob/master/screenshots/ui.gif
   :target: https://github.com/evildecay/etcdkeeper/blob/master/screenshots/ui.gif
   :alt: image
